...
| {{escapeCell .Content}} | {{formatAuthor .Author .CommentURL}} | {{formatDate .Date}} | {{authorizationStatus .IsAuthorized}} | [View]({{.CommentURL}}) |
{{- end}}
...
💬 **[Share your feedback on this report]({{.FeedbackURL}})** — Were the risks accurate? Were the action items useful? Your feedback helps improve Soundings.
